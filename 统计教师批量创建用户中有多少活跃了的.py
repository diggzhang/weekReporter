...
# configure daterange
startDate = datetime.datetime(2015, 8, 30, 0, 0, 0, 000000)
endDate   = datetime.datetime(2015, 10, 3, 0, 0, 0, 000000)
...
print("All teacher create students: ")
print(len(flatAllstudents))

# check all user is in points?
def stuInPoints(flatAllstudents, startDate):
    pipeLine = [
        {"$match": {
            "createdBy": {
                "$gte": startDate
...
stuActInPoints = stuInPoints(flatAllstudents, startDate)
print("All work students: ")
print(stuActInPoints)
print(len(stuActInPoints))
